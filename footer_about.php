<html lang="en">
  <head>
      ...
      <title>About ∙ Instakilogram</title>
  ...
  <body>
    ...
    <main>
      ...
      <!-- This page is referenced
          Community Guidelines | Instagram – accessed 15 May 2022. https://help.instagram.com/477434105621119/?helpref=hc_fnav&cms_id=477434105621119&maybe_redirect_pol=true -->

      <div class="citation">
        <h3>Please notice that this is referenced</h3>
        <h3>Community Guidelines | Instagram – accessed 15 May 2022. https://help.instagram.com/477434105621119/?helpref=hc_fnav&cms_id=477434105621119&maybe_redirect_pol=true</h3>
      </div>
      ...
      <div class="container_etc">
        ...
        <p>We created the Community Guidelines so that you can help us foster and protect this amazing community. By using Instagram, you agree to these guidelines and our Terms of Use. We're committed to these guidelines and we hope you are too. Overstepping these boundaries may result in deleted content, disabled accounts or other restrictions.</p>
        <p>In some cases, we allow content for public awareness that would otherwise go against our Community Guidelines – if it is newsworthy and in the public interest. We only do this after weighing the public interest value against the risk of harm and we look to international human rights standards to make these judgments.</p>

        <ul>
          <li>Share only photos and videos that you've taken or have the right to share.</li>
        </ul>
          <p>As always, you own the content that you post on Instagram. Remember to post authentic content, and don't post anything you've copied or collected from the Internet that you don't have the right to post. Learn more about intellectual property rights.</p>
        <ul>
          <li>Post photos and videos that are appropriate for a diverse audience.</li>
        </ul>
        ...
        <ul>
          ...
          <p>You don't have to use your real name on Instagram, but we do require Instagram users to provide us with accurate and up-to-date information. Don't impersonate others and don't create accounts for the purpose of violating our guidelines or misleading others.</p>
        <ul>
          <li>Follow the law.</li>
        </ul>
          <p>Instagram is not a place to support or praise terrorism, organised crime or hate groups. Offering sexual services, buying or selling firearms, alcohol and tobacco products between private individuals, and buying or selling non-medical or pharmaceutical drugs are also not allowed. We also remove content that attempts to trade, co-ordinate the trade of, donate, gift, or ask for non-medical drugs, as well as content that either admits to personal use (unless in the recovery context) or coordinates or promotes the use of non-medical drugs. Instagram also prohibits the sale of live animals between private individuals, although brick-and-mortar shops may offer these sales. No one may coordinate poaching or selling of endangered species or their parts.</p>
        ...
        <ul>
          <li>Respect other members of the Instagram community.</li>
        </ul>
        ...
        <ul>
          <li>Maintain our supportive environment by not glorifying self-injury.</li>
        </ul>
          <p>The Instagram community cares for each other, and is often a place where people facing difficult issues such as eating disorders, cutting or other kinds of self-injury come together to create awareness or find support. We try to do our part by providing education in the app and adding information in the Help Centre so that people can get the help they need.</p>
          <p>Encouraging or urging people to embrace self-injury is counter to this environment of support, and we’ll remove it or disable accounts if it’s reported to us. We may also remove content identifying victims or survivors of self-injury if the content targets them for attack or humour.</p>
        <ul>
            <li>Be thoughtful when posting newsworthy events.</li>
        </ul>
          <p>We understand that many people use Instagram to share important and newsworthy events. Some of these issues can involve graphic images. Because so many different people and age groups use Instagram, we may remove videos of intense, graphic violence to make sure that Instagram stays appropriate for everyone.</p>
